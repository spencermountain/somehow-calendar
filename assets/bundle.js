...
var calendar = _dereq_('./src'); // const inputs = require('somehow-input')


var start = 'Jan 1 2019';
var end = spacetime('Dec 28 2019');
...
},{"./src":10,"spacetime":3}],2:[function(_dereq_,module,exports){
...
var drawWeeks = _dereq_('./draw/weeks');
...
function () {
  ...
  _createClass(Show, [{
    ...
    key: "label",
    value: function label(d, _label) {
      d = spacetime(d);
      var date = d.format('iso-short');
      this.data.labels[date] = _label;
    }
  }, {
    key: "build",
    value: function build() {
      ...
      var inside = months.map(function (d) {
        if (_this3.options.mode === 'timeline') {
          return drawTimeline(d, _this3, _this3.options);
        }

        return drawMonth(d, _this3, _this3.options);
      });
      ...
      return this.h(_templateObject(), this.options.mode === 'weeks' ? styles.col : styles.row, inside);
    }
  }]);
...
},{"./draw/month":7,"./draw/timeline":8,"./draw/weeks":9,"htm":2,"spacetime":3,"vhtml":4}],6:[function(_dereq_,module,exports){
"use strict";
...
var drawDay = function drawDay(d, cal, ignore) {
  var style = {
    'flex-basis': 50,
    flex: 1,
...
},{"spacetime":3}],7:[function(_dereq_,module,exports){
"use strict";
...
var drawWeek = function drawWeek(w, cal, month) {
  ...
  var days = w.every('day', end).map(function (d) {
    var ignore = d.format('month') !== month;
    return drawDay(d, cal, ignore);
  });
  return cal.h(_templateObject(), styles.week, days);
};

var drawMonth = function drawMonth(start, cal) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  var monthName = start.format('month-short');
  monthName = cal.h(_templateObject2(), styles.monthName, monthName);
  ...
  return cal.h(_templateObject3(), styles.month, monthName, weeks);
};

module.exports = drawMonth;

},{"./_drawDay":6}],8:[function(_dereq_,module,exports){
"use strict";
...
var drawMonth = function drawMonth(start, cal) {
  ...
  if (end.day() === 0) {
    weeks.push(cal.h(_templateObject2()));
  }

  return cal.h(_templateObject3(), styles.month, styles.monthName, monthName, styles.weeks, weeks);
};

module.exports = drawMonth;

},{"./_drawDay":6}],9:[function(_dereq_,module,exports){
"use strict";
...
var drawWeek = function drawWeek(w, cal, year) {
  var end = w.endOf('week');
  w = w.minus(2, 'hour');
  var days = w.every('day', end).map(function (d) {
    var ignore = d.year() !== year;
    return drawDay(d, cal, ignore);
  });
  return cal.h(_templateObject(), styles.week, days);
};

var drawYear = function drawYear(start, cal) {
  start = start.startOf('year');
  var year = start.year();
  var end = start.endOf('year');
  start = start.startOf('week').minus(2, 'hours');
  var weeks = start.every('week', end).map(function (d) {
    return drawWeek(d, cal, year);
  });
  return cal.h(_templateObject2(), styles.all, styles.week + styles.labels, weeks);
};

module.exports = drawYear;

},{"./_drawDay":6}],10:[function(_dereq_,module,exports){
"use strict";
...
module.exports = {
  ...
  weeks: function weeks(start, end) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    options.mode = 'weeks';
    return new Show(start, end, options);
  }
