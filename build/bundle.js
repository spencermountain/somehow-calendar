...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[7](/*d*/ ctx[14]);
    	}
    	...
    	return {
    		c() {
    			...
    			attr(div1, "style", div1_style_value = "background-color:" + /*d*/ ctx[14].color);
    			attr(div1, "title", div1_title_value = /*d*/ ctx[14].iso);
    			toggle_class(div1, "today", /*d*/ ctx[14].isToday);
    			toggle_class(div1, "weekend", /*d*/ ctx[14].isWeekend);
    			toggle_class(div1, "highlight", /*d*/ ctx[14].color !== "none");
    		},
    		m(target, anchor) {
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*weeks*/ 4 && t_value !== (t_value = /*d*/ ctx[14].num + "")) set_data(t, t_value);

    			if (dirty & /*weeks*/ 4 && div1_style_value !== (div1_style_value = "background-color:" + /*d*/ ctx[14].color)) {
    				attr(div1, "style", div1_style_value);
    			}

    			if (dirty & /*weeks*/ 4 && div1_title_value !== (div1_title_value = /*d*/ ctx[14].iso)) {
    ...
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*d*/ ctx[14].inMonth) return create_if_block;
    ...
    // (128:2) {#each weeks as w}
    function create_each_block$1(ctx) {
    	let div;
    	let t;
    	let each_value_1 = /*w*/ ctx[11];
    	let each_blocks = [];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [date, onClick, weeks, days, showToday, $$scope, slots, click_handler];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*months, days, $$scope*/ 19) {
    				each_value = /*months*/ ctx[1];
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [days, months, date, slots, $$scope];
    }
    ...
    <span class="f08 grey">- a svelte html calendar.</span>`;
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*days*/ 1) quarter_changes.days = /*days*/ ctx[0];
