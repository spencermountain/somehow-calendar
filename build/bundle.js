...
var app = (function () {
    ...
    /* src/WeekList.svelte generated by Svelte v3.35.0 */

    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-1dbg59b-style";
    	style.textContent = ".dayName.svelte-1dbg59b{font-size:0.7rem;color:#838b91;text-align:center}.week.svelte-1dbg59b{display:flex;flex-direction:row;justify-content:space-around;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}.day.svelte-1dbg59b{position:relative;flex:1;margin:0.5%;border-radius:3px;box-shadow:2px 1px 6px 0px rgba(0, 0, 0, 0.2);min-width:13px;min-height:12px;box-sizing:border-box;font-size:9px;color:#a3a5a5;overflow:hidden;z-index:1;cursor:pointer}.day.svelte-1dbg59b:hover{box-shadow:1px 4px 10px 1px rgba(0, 0, 0, 0.2)}.highlight.svelte-1dbg59b{box-shadow:1px 4px 10px 1px rgba(0, 0, 0, 0.4)}.square.svelte-1dbg59b{padding-top:15%;position:relative}.today.svelte-1dbg59b{background-color:lightsteelblue;border:1px solid lightsteelblue !important;color:white}.num.svelte-1dbg59b{position:absolute;z-index:4;font-size:14px;color:#949a9e;opacity:0.8;width:100%;height:100%;top:0px;text-align:center;margin:auto;opacity:0;cursor:pointer}.num.svelte-1dbg59b:hover{opacity:0.8}.weekend.svelte-1dbg59b{background-color:#f0f0f0}@media only screen and (max-width: 400px){.day.svelte-1dbg59b{border-radius:2px;margin:0.5%;box-shadow:1px 1px 1px 0px rgba(0, 0, 0, 0.2)}.num.svelte-1dbg59b{display:none}}";
    ...
    function create_each_block_2(ctx) {
    	...
    	return {
    		c() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr(div, "class", "dayName svelte-1dbg59b");
    		},
    		m(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[11](/*d*/ ctx[19]);
    	}
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			t = text(t_value);
    			attr(div0, "class", "num svelte-1dbg59b");
    			attr(div1, "class", "day square svelte-1dbg59b");
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*weeks*/ 2 && t_value !== (t_value = /*d*/ ctx[19].num + "")) set_data(t, t_value);

    			if (dirty & /*weeks*/ 2 && div1_style_value !== (div1_style_value = "background-color:" + /*d*/ ctx[19].color)) {
    				attr(div1, "style", div1_style_value);
    			}

    			if (dirty & /*weeks*/ 2 && div1_title_value !== (div1_title_value = /*d*/ ctx[19].iso)) {
    ...
    function create_each_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			t = space();
    			attr(div, "class", "week svelte-1dbg59b");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "week svelte-1dbg59b");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*start, end*/ 24) {
    			$$invalidate(7, setup = getWeeks(start, end) || []);
    		}

    		if ($$self.$$.dirty & /*days*/ 32) {
    			$$invalidate(8, colors = fmtDays(days));
    		}

    		if ($$self.$$.dirty & /*setup, colors*/ 384) {
    			$$invalidate(1, weeks = setup.map(w => {
    				return w.map(day => {
    ...
    class WeekList extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-1dbg59b-style")) add_css$1();
    ...
    <span class="f08 grey">- a svelte html calendar.</span>`;
    			...
    			t3 = space();
    			div1 = element("div");
    			create_component(weeklist.$$.fragment);
    		...
    		m(target, anchor) {
    			...
    			append(div2, t3);
    			append(div2, div1);
    			mount_component(weeklist, div1, null);
    			current = true;
    		},
    		p(ctx, [dirty]) {
    			const weeklist_changes = {};
    			if (dirty & /*end*/ 1) weeklist_changes.end = /*end*/ ctx[0];
    			if (dirty & /*days*/ 2) weeklist_changes.days = /*days*/ ctx[1];
    			weeklist.$set(weeklist_changes);
    		},
    		i(local) {
    			if (current) return;
    			transition_in(weeklist.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(weeklist.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			if (detaching) detach(div2);
    			destroy_component(weeklist);
    		}
    	};
    }
